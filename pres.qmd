...
- Stream sites divided into "runs", each with tidally influenced streams
...
-   Sites randomly selected within each grid

\vspace{2em}
-   Further random selection of 4 points across hexagons per sampling period (32/year)
...
<div class="flowchart">
  ...
  <div class="box fragment" data-fragment-index="6">Submit data to FDEP in WIN format</div>
  <div class="arrow fragment" data-fragment-index="6">&#8681;</div>
  <div class="box fragment" data-fragment-index="7">Submit data to USF Water Atlas for updated dashboard</div>
...
-   Combined with strata code to generate yearly sampling schedule for streamlined process
:::
...
::: {.column width="30%"}
![](www/qaqc.png) 
![](www/quarto.png){.fragment .fade-in fragment-index=3}
:::
:::
...
-   Open science tools provide benefits to all aspect of sampling program:
...
-   Future efforts:
    ...
    -   Create more public facing applications for public use
    -   Package development?
:::
